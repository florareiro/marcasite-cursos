...
<div class="mb-4">
    <div class="grid gap-2 md:grid-cols">
        ...
        <form wire:submit="update({{$product->id}})" class="px-4 py-3 mb-8 bg-white rounded-lg dark:bg-gray-700">
            ...
            <div class="flex justify-between mt-4 text-sm">
                <a data-tooltip-target="tooltip-cancel" href="{{ route('gallerys.index') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                    <span>Cancelar</span>
                ...
                <button data-popover-target="popover-save" type="submit" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                    <span>{{ $productId ? 'Atualizar produto':'Criar produto' }}</span>
    ...
    <div data-popover id="popover-save" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-700">
        ...
        <div class="p-1">
            <p>O produto foi modificado, salve.</p>
        </div>

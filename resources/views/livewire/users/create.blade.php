        ...
        <form wire:submit.prevent="save">
            ...
            <div class="grid grid-cols-1 gap-4">
                <label class="mt-4 text-sm w-full">
                    ...
                    <input wire:model.defer="company" class="w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Empresa" type="text"/>
                    <div class="text-red-500">@error('company') <span class="error">{{ $message }}</span> @enderror</div>
                </label>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <label class="mt-4 text-sm w-full">
                    ...
                    <select wire:model.live="subsType" id="subsType" class="block w-full mt-1 text-sm dark:text-gray-300 text-gray-800 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <span class="text-gray-700 dark:text-gray-400">
          Curso
            ...
            <select wire:model.live="productId" id="productId" class="block w-full mt-1 text-sm dark:text-gray-300 text-gray-800 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                <option value="">Selecione um Curso</option>
